...
revival and are pending an overhaul — treat them as starting points only.
The legacy `.httr-oauth` PIN dance described in older docs is no longer
required (see API credentials above).
